...
import { Button, Container, Row, Col, Form, Dropdown, DropdownButton, Spinner, Alert } from 'react-bootstrap';
        ...
        <Col md={3}>
          <Form onSubmit={handleSubmitBrand(onSubmitBrand)}>
              <Form.Group>
                ...
                <Form.Control
                  {...registerBrand('brand', {required: true, minLength: 3})}
                />
